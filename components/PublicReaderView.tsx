  ...
  return (
    <div className="min-h-screen pb-32">
      <nav className="max-w-6xl mx-auto px-6 py-12 flex justify-between items-center">
        <button onClick={onBackToApp} className="text-4xl serif font-black tracking-tighter hover:opacity-80 transition-opacity">
          Loopy<span className="text-violet-600">.</span>
        </button>
        <button 
          onClick={onBackToApp} 
