            ...
            <div className="space-y-10">
              <div className="space-y-4">
                ...
                <input 
                  ...
                  className="w-full text-4xl serif font-black bg-yellow-50 px-6 py-5 neo-brutal outline-none placeholder:text-stone-300 text-black"
              ...
              <div className="space-y-4">
                ...
                <textarea 
                    ...
                    className="w-full text-lg serif italic font-medium bg-emerald-50/50 p-8 neo-brutal outline-none min-h-[160px] text-black shadow-none placeholder:text-stone-300"
              ...
              <div className="pt-8 border-t-2 border-black space-y-4">
                ...
                <div className="flex gap-4">
                  ...
                  <button 
                    ...
                    className="bg-black text-white px-6 neo-brutal text-[10px] font-black uppercase tracking-widest"
                  >
                    ADD
                  </button>
                </div>
          ...
          <div className="bg-white p-12 neo-brutal-static space-y-10">
            <div className="flex justify-between items-center">
              ...
              <button 
                ...
                className="bg-yellow-300 text-black px-4 py-2 neo-brutal text-[8px] font-black uppercase tracking-widest"
              >
            ...
            <div className="space-y-6">
              ...
              <div className="relative pt-8 border-t-2 border-black">
                <input 
                  ...
                  className="w-full pl-8 pr-16 py-5 neo-brutal text-sm font-bold italic bg-yellow-50 outline-none"
